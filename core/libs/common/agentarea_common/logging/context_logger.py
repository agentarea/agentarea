...
class ContextLogger:
    ...
    def __init__(self, logger: logging.Logger, user_context: Optional[UserContext] = None):
    ...
    def critical(self, msg: str, *args: Any, extra: Optional[Dict[str, Any]] = None, **kwargs: Any) -> None:

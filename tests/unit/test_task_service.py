...
class TestTaskService:
    ...
    async def test_create_and_start_test_task_success(self, mock_task_factory, task_service, mock_event_broker, sample_agent_id):
    ...
    @patch('agentarea.modules.tasks.task_service.TaskFactory')
    async def test_create_and_start_test_task_factory_error(self, mock_task_factory, task_service, mock_event_broker, sample_agent_id):
    ...
    @patch('agentarea.modules.tasks.task_service.TaskFactory')
    async def test_create_and_start_test_task_event_publish_error(self, mock_task_factory, task_service, mock_event_broker, sample_agent_id):

...
export interface paths {
    ...
    "/v1/webhooks/{webhook_id}": {
         ...
         */
        get: operations["handle_webhook_v1_webhooks__webhook_id__post"];
        /**
         * Handle webhook requests
         * @description Process incoming webhook requests for registered triggers
         */
        put: operations["handle_webhook_v1_webhooks__webhook_id__post"];
        /**
         * Handle webhook requests
         * @description Process incoming webhook requests for registered triggers
         */
        post: operations["handle_webhook_v1_webhooks__webhook_id__post"];
        /**
         * Handle webhook requests
         * @description Process incoming webhook requests for registered triggers
         */
        delete: operations["handle_webhook_v1_webhooks__webhook_id__post"];
        /**
         * Handle webhook requests
         * @description Process incoming webhook requests for registered triggers
         */
        options: operations["handle_webhook_v1_webhooks__webhook_id__post"];
        /**
         * Handle webhook requests
         * @description Process incoming webhook requests for registered triggers
         */
        head: operations["handle_webhook_v1_webhooks__webhook_id__post"];
        /**
         * Handle webhook requests
         * @description Process incoming webhook requests for registered triggers
         */
        patch: operations["handle_webhook_v1_webhooks__webhook_id__post"];
        trace?: never;
    };
    "/v1/webhooks/health": {
        parameters: {
...
export interface operations {
    ...
    handle_webhook_v1_webhooks__webhook_id__post: {
        parameters: {
            query?: never;
            header?: never;
            path: {

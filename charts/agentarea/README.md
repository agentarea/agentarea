...
| sandboxRuntime.manifests.allowed | object | `{}` |  |
| sandboxRuntime.manifests.locked | object | `{}` |  |
...
| sandboxRuntime.opensandbox.persistWorkspace | bool | `true` |  |
...
| sandboxRuntime.opensandbox.images.allowed | string | `""` |  |
| sandboxRuntime.opensandbox.images.locked | string | `""` |  |
...
| sandboxRuntime.e2b.internetAccess.allowed | bool | `false` |  |
| sandboxRuntime.e2b.internetAccess.locked | bool | `false` |  |
| sandboxRuntime.e2b.apiKeySecretRef.name | string | `""` |  |
| sandboxRuntime.e2b.apiKeySecretRef.key | string | `""` |  |
| sandboxRuntime.e2b.templates.allowed | string | `""` |  |
| sandboxRuntime.e2b.templates.locked | string | `""` |  |
| sandboxRuntime.cube.apiUrl | string | `""` |  |
| sandboxRuntime.cube.sandboxUrl | string | `""` |  |
| sandboxRuntime.cube.allowInsecure | bool | `false` |  |
| sandboxRuntime.cube.internetAccess.allowed | bool | `false` |  |
| sandboxRuntime.cube.internetAccess.locked | bool | `false` |  |
| sandboxRuntime.cube.apiKeySecretRef.name | string | `""` |  |
| sandboxRuntime.cube.apiKeySecretRef.key | string | `""` |  |
| sandboxRuntime.cube.templates.allowed | string | `""` |  |
| sandboxRuntime.cube.templates.locked | string | `""` |  |

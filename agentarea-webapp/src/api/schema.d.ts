...
export interface paths {
    ...
    "/oauth2/{path}": {
         ...
         */
        get: operations["hydra_oauth2_proxy_oauth2__path__post"];
        /**
         * Hydra Oauth2 Proxy
         * @description Proxy all /oauth2/* requests through to Hydra (excluding /register handled above).
         */
        put: operations["hydra_oauth2_proxy_oauth2__path__post"];
        /**
         * Hydra Oauth2 Proxy
         * @description Proxy all /oauth2/* requests through to Hydra (excluding /register handled above).
         */
         ...
         * @description Proxy all /oauth2/* requests through to Hydra (excluding /register handled above).
         */
        delete: operations["hydra_oauth2_proxy_oauth2__path__post"];
        options?: never;
        head?: never;
        /**
         * Hydra Oauth2 Proxy
         * @description Proxy all /oauth2/* requests through to Hydra (excluding /register handled above).
         */
        patch: operations["hydra_oauth2_proxy_oauth2__path__post"];
        trace?: never;
    };
    ...
    "/webhooks/{webhook_id}": {
         ...
         */
        get: operations["handle_webhook_webhooks__webhook_id__post"];
        /**
         * Handle webhook requests
         * @description Process incoming webhook requests for registered triggers
         */
        put: operations["handle_webhook_webhooks__webhook_id__post"];
        /**
         * Handle webhook requests
         * @description Process incoming webhook requests for registered triggers
         */
         ...
         * @description Process incoming webhook requests for registered triggers
         */
        delete: operations["handle_webhook_webhooks__webhook_id__post"];
        /**
         * Handle webhook requests
         * @description Process incoming webhook requests for registered triggers
         */
        options: operations["handle_webhook_webhooks__webhook_id__post"];
        /**
         * Handle webhook requests
         * @description Process incoming webhook requests for registered triggers
         */
        head: operations["handle_webhook_webhooks__webhook_id__post"];
        /**
         * Handle webhook requests
         * @description Process incoming webhook requests for registered triggers
         */
        patch: operations["handle_webhook_webhooks__webhook_id__post"];
        trace?: never;
    };

...
from agentarea_tasks.domain.events import TaskCreated, TaskStatusChanged
from agentarea_tasks.domain.models import Task as DomainTask
from agentarea_tasks.domain.models import TaskPriority, TaskType
from agentarea_tasks.infrastructure.repository import TaskRepositoryInterface

...
async def create_task(
    ...
    try:
        ...
        # Use workspace_id as user_id fallback since MCP requests may not have user context
        # In production, MCP endpoints should require authentication and extract user_id from context
        task = await task_service.create_and_execute_task_with_workflow(
            ...
            user_id=workspace_id,  # Use workspace_id as user_id for MCP requests (no authenticated user context)

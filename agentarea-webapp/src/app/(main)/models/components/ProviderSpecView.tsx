    ...
    return (
      <div className="py-1">
        <EmptyState
          ...
          description={
            hasNoData
              ? "Specs describe which providers and models exist. They are supplied by the platform registry, and none have been synced into this deployment yet."
          ...
          action={
            hasNoData ? undefined : { label: "Clear search", href: "/models" }
          }
        />
      </div>
    );

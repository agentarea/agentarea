...
from agentarea_cli.exceptions import AuthenticationError, ValidationError
...
@click.pass_context
def list(ctx, output_format: str, provider: str | None, status: str | None):

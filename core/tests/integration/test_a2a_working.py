...
class TestA2AWorking:
    ...
    def test_a2a_well_known_with_dev_auth(self, client):
        ...
        assert "not found" in error_data["detail"].lower() or "does not exist" in error_data["detail"].lower()
    ...
    def test_a2a_rpc_with_dev_auth(self, client):
        ...
        response = client.post(f"/api/v1/agents/{agent_id}/a2a/rpc", 
                              headers=headers,
                              json={
                                  "jsonrpc": "2.0",
                                  "id": "test-123",
    ...
    def test_a2a_authentication_required(self, client):
        ...
        response = client.post(f"/api/v1/agents/{agent_id}/a2a/rpc", json={
            "jsonrpc": "2.0",
            "id": "test",
            "method": "message/send",
            "params": {}

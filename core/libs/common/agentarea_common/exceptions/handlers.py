...
async def workspace_resource_not_found_handler(request: Request, exc: WorkspaceResourceNotFound) -> JSONResponse:
...
async def missing_workspace_context_handler(request: Request, exc: MissingWorkspaceContext) -> JSONResponse:

...
def test_trigger_execute_public_creates_task(
    ...
    execute_resp = alice_client.post(
        f"{alice_client.ws}/triggers/{trigger_id}/execute",
...
def test_trigger_execute_unknown_trigger_returns_404(
    ...
    resp = alice_client.post(
        f"{alice_client.ws}/triggers/00000000-0000-0000-0000-000000000000/execute",
        json={"payload": {}},
    )
...
def test_trigger_execute_disabled_trigger_rejected(
    ...
    alice_client.post(f"{alice_client.ws}/triggers/{trigger['id']}/disable").raise_for_status()

    resp = alice_client.post(
        f"{alice_client.ws}/triggers/{trigger['id']}/execute",
        json={"payload": {}},
    )

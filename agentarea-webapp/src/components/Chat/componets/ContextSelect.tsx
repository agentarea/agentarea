  ...
  return (
    <Select value={value} onValueChange={onValueChange} disabled={disabled}>
      <SelectTrigger
        aria-label={label}
        className={cn(
          "group h-7 w-fit min-w-0 max-w-full rounded-full border border-transparent bg-transparent pl-2 pr-3 text-left text-xs text-zinc-500 shadow-none sm:max-w-[18rem] lg:max-w-[20rem]",
          "transition-all duration-150 ease-out hover:bg-zinc-100/70 hover:text-zinc-500",
          "focus:border-transparent focus:ring-0 focus-visible:ring-0 data-[state=open]:bg-zinc-100/80 data-[state=open]:text-zinc-500",
      ...
      >
        <div className="flex min-w-0 flex-1 flex-nowrap items-center gap-1.5 overflow-hidden whitespace-nowrap">
          ...
          <span className="block min-w-0 flex-1 truncate whitespace-nowrap text-[13px] font-normal leading-none text-zinc-400 dark:text-zinc-300">

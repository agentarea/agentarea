...
from agentarea_common.utils.types import AgentCard, AgentCapabilities, AgentSkill
...
class TestA2AAgentDiscovery:
    ...
    async def test_handle_agent_card_full_featured_agent(self, mock_agent_service, sample_agent, mock_auth_context):
    ...
    async def test_handle_agent_card_minimal_agent(self, mock_agent_service, minimal_agent, mock_auth_context):
    ...
    async def test_get_agent_well_known_success(self, mock_agent_service, sample_agent, mock_auth_context):
    ...
    async def test_get_agent_well_known_agent_not_found(self, mock_agent_service, mock_auth_context):
    ...
    async def test_agent_discovery_includes_availability_status(self, mock_agent_service, mock_auth_context):

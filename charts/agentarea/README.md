...
| mcpManager.features.enabled[2] | string | `"warm_pool"` |  |
| mcpManager.features.variants | object | `{}` |  |
| mcpManager.warmPool.enabled | bool | `true` |  |
...
| sandboxRuntime.idleTTL | string | `"15m"` |  |
| sandboxRuntime.sessionRecordTTL | string | `"24h"` |  |
| sandboxRuntime.executionRecordTTL | string | `"24h"` |  |
| sandboxRuntime.maxExecutionTimeoutSeconds | int | `1800` |  |
| sandboxRuntime.defaultExecutionTimeoutSeconds | int | `120` |  |
| sandboxRuntime.executionQueueTimeout | string | `"5m"` |  |
| sandboxRuntime.executionCompletionGrace | string | `"2m"` |  |
| sandboxRuntime.workspace.maxFiles | string | `"10000"` |  |
| sandboxRuntime.workspace.maxFileBytes | string | `"268435456"` |  |
| sandboxRuntime.workspace.maxBytes | string | `"2147483648"` |  |
| sandboxRuntime.workspace.signedUrlTTL | string | `"1h"` |  |
...
| sandboxRuntime.opensandbox.secureAccess | bool | `true` |  |
| sandboxRuntime.opensandbox.isolation | string | `""` |  |
| sandboxRuntime.opensandbox.runtimeIdentity | string | `""` |  |
...
| sandboxRuntime.opensandbox.image | string | `""` |  |
| sandboxRuntime.opensandbox.entrypoint | list | `[]` |  |
| sandboxRuntime.e2b.apiUrl | string | `""` |  |
| sandboxRuntime.e2b.sandboxUrl | string | `""` |  |
| sandboxRuntime.e2b.allowInsecure | bool | `false` |  |
| sandboxRuntime.e2b.isolation | string | `"firecracker"` |  |
| sandboxRuntime.e2b.attestationPath | string | `"/etc/agentarea/isolation-attestation.json"` |  |
| sandboxRuntime.e2b.runtimeIdentity | string | `""` |  |
| sandboxRuntime.e2b.apiKeySecretRef.name | string | `""` |  |
| sandboxRuntime.e2b.apiKeySecretRef.key | string | `""` |  |
| sandboxRuntime.e2b.template | string | `""` |  |
| sandboxRuntime.cube.apiUrl | string | `""` |  |
| sandboxRuntime.cube.sandboxUrl | string | `""` |  |
| sandboxRuntime.cube.allowInsecure | bool | `false` |  |
| sandboxRuntime.cube.isolation | string | `"firecracker"` |  |
| sandboxRuntime.cube.attestationPath | string | `"/etc/agentarea/isolation-attestation.json"` |  |
| sandboxRuntime.cube.runtimeIdentity | string | `""` |  |
| sandboxRuntime.cube.apiKeySecretRef.name | string | `""` |  |
| sandboxRuntime.cube.apiKeySecretRef.key | string | `""` |  |
| sandboxRuntime.cube.template | string | `""` |  |
...
| registryReconcile.registries[3].name | string | `"system-openapi-connections"` |  |
| registryReconcile.registries[3].source_url | string | `"agentarea_api/data/openapi-connectors.json"` |  |
| registryReconcile.registries[4].name | string | `"system-skills-curated"` |  |
| registryReconcile.registries[4].source_url | string | `"https://agentarea-mcp-registry.s3.amazonaws.com/registry/system/skills.json"` |  |

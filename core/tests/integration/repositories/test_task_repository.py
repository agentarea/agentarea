...
class TestTaskRepository:
    ...
    @pytest.mark.asyncio
    async def test_list_tasks_with_data(self, task_repository: SQLAlchemyTaskRepository, model_factory):
    ...
    @pytest.mark.asyncio
    async def test_find_by_session_id(self, task_repository: SQLAlchemyTaskRepository, model_factory):
    ...
    @pytest.mark.asyncio
    async def test_task_with_complex_parameters(self, task_repository: SQLAlchemyTaskRepository, model_factory):
    ...
    @pytest.mark.asyncio
    async def test_task_status_lifecycle(self, task_repository: SQLAlchemyTaskRepository, model_factory):
    ...
    @pytest.mark.asyncio 
    async def test_multiple_sessions_isolation(self, task_repository: SQLAlchemyTaskRepository, model_factory):

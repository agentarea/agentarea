...
export const zAgentCard = z.object({
  ...
  name: z.string(),
  protocolVersion: z.string().optional().default("0.3.0"),
  ...
  supportedInterfaces: z.array(zAgentInterface).nullish(),
  supportsAuthenticatedExtendedCard: z.boolean().optional().default(true),
  url: z.string(),

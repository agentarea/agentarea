...
def test_openapi_connections_preview_valid_spec(alice_client: httpx.Client) -> None:
    resp = alice_client.post(
        f"{alice_client.ws}/openapi-connections/preview-spec",
        json={
...
def test_openapi_connections_discover_tools_on_connection(
    ...
    discover = alice_client.post(
        f"{alice_client.ws}/openapi-connections/{conn['id']}/discover-tools"
    )
    ...
    alice_client.delete(f"{alice_client.ws}/openapi-connections/{conn['id']}")

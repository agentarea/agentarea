...
class AgentRepository:
    ...
    async def get_by_id(self, agent_id: str, user_scoped: bool = False) -> Optional[Agent]:
        """Get agent by ID."""
    ...
    async def get_agent_by_name(self, name: str, user_scoped: bool = False) -> Optional[Agent]:
        """Get agent by name."""
        repo = self._get_repo(user_scoped)
    ...
    async def update_agent(self, agent_id: str, user_scoped: bool = False, **kwargs) -> Optional[Agent]:
        """Update an agent."""
        repo = self._get_repo(user_scoped)

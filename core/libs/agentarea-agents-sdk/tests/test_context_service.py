...
class TestInMemoryContextService:
    ...
    async def test_append_and_list_events(self, context_service: InMemoryContextService):
        ...
        event2 = ContextEvent(type="tool_execution_finished", payload={"tool_name": "search", "result": "done"})
...
class TestEventsToMessages:
    ...
    def test_assistant_message_conversion(self):
        ...
        events = [
            ContextEvent(type="assistant_message", payload={"content": "Hello world"})
        ]
    ...
    def test_assistant_message_with_tool_calls(self):
        ...
        events = [
            ContextEvent(type="assistant_message", payload={"content": "Let me search", "tool_calls": tool_calls})
        ]
    ...
    def test_tool_execution_finished_conversion(self):
        ...
        events = [
            ContextEvent(type="tool_execution_finished", payload={
                "tool_name": "search",
                "tool_call_id": "call1",
    ...
    def test_tool_execution_error_conversion(self):
        ...
        events = [
            ContextEvent(type="tool_execution_error", payload={
                "tool_name": "search",
                "tool_call_id": "call1",
    ...
    def test_complete_conversation_flow(self):
        ...
        events = [
            ContextEvent(type="assistant_message", payload={
...
class TestContextPersistenceIntegration:
    ...
    async def test_context_preloading_across_runs(self, context_service: InMemoryContextService):
        ...
        await context_service.append_event(task_id, ContextEvent(
            type="assistant_message", 
            payload={"content": "Initial message from first run"}
        ))
        await context_service.append_event(task_id, ContextEvent(
            type="tool_execution_finished",
            payload={"tool_name": "search", "tool_call_id": "call1", "result": "Previous search results"}
        ))
    ...
    async def test_multi_agent_task_delegation(self, context_service: InMemoryContextService):
        ...
        await context_service.append_event(parent_task_id, ContextEvent(
            type="assistant_message",
            payload={"content": "I need to delegate this subtask"}
        ))
        ...
        await context_service.append_event(subtask_id, ContextEvent(
            type="assistant_message",
            payload={"content": "Working on the delegated subtask"}
        ))

  ...
  "w-max inline-flex gap-1 items-center rounded-full border font-base transition-colors",
  {
    variants: {
      variant: {
        ...
        indigo: "border-transparent bg-indigo-100 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-200",
        emerald: "border-transparent bg-emerald-100 text-emerald-700 dark:bg-emerald-900 dark:text-emerald-200",

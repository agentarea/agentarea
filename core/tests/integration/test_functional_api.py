...
class FunctionalAPITester:
    ...
    def __init__(self, base_url: str = "http://localhost:8000"):
        ...
        # Test data storage
        self.provider_spec_id: Optional[str] = None
        self.provider_config_id: Optional[str] = None
        self.model_spec_id: Optional[str] = None
        self.model_instance_id: Optional[str] = None
    ...
    async def test_get_ollama_provider_spec(self) -> bool:
        ...
        try:
            ...
            self.log_test_result("Get Ollama Provider Spec", False, f"Exception: {str(e)}")
            return False
    ...
    async def test_create_provider_config(self) -> bool:
        ...
        try:
            ...
            self.log_test_result("Create Provider Config", False, f"Exception: {str(e)}")
            return False
    ...
    async def test_create_model_instance(self) -> bool:
        ...
        try:
            ...
            self.log_test_result("Create Model Instance", False, f"Exception: {str(e)}")
            return False
    ...
    async def test_create_agent(self) -> bool:
        ...
        try:
            ...
            self.log_test_result("Create Agent", False, f"Exception: {str(e)}")
            return False
    ...
    async def test_chat_mode_task(self) -> bool:
        ...
        try:
            ...
            self.log_test_result("Chat Mode Task", False, f"Exception: {str(e)}")
            return False
    ...
    async def test_a2a_mode_task(self) -> bool:
        ...
        try:
            ...
            self.log_test_result("A2A Mode Task", False, f"Exception: {str(e)}")
            return False
    ...
    async def test_agent_well_known(self) -> bool:
        ...
        try:
            ...
            self.log_test_result("Agent Well-Known", False, f"Exception: {str(e)}")
            return False
    ...
    async def test_task_listing(self) -> bool:
        ...
        try:
            ...
            self.log_test_result("Task Listing", False, f"Exception: {str(e)}")
            return False

  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <div className="relative w-max">
        <div data-featured-icon="true" className={`relative flex shrink-0 items-center justify-center *:data-icon:size-6 rounded-full size-12 ${getIconBackground()}`}>
          {getIcon()}
          <svg width="336" height="336" viewBox="0 0 336 336" fill="none" className="text-zinc-300 pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 dark:text-zinc-500">
            ...
            <defs><radialGradient id="paint0_radial_4947_375931" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(168 168) rotate(90) scale(168 168)"><stop></stop><stop offset="1" stopOpacity="0"></stop></radialGradient></defs>
        </svg>
        </div>
        </div>

...
def test_project_file_upload_list_download_delete_roundtrip(
    ...
    dl = alice_client.get(f"{alice_client.ws}/projects/{project_id}/files/{filename}")
    ...
    deleted = alice_client.delete(f"{alice_client.ws}/projects/{project_id}/files/{filename}")
    assert deleted.status_code == 204, deleted.text[:200]

    listing_after = alice_client.get(f"{alice_client.ws}/projects/{project_id}/files").json()
...
def test_project_file_download_404_when_missing(
    ...
    dl = alice_client.get(f"{alice_client.ws}/projects/{project_id}/files/never.txt")
...
def test_project_files_are_workspace_scoped(
    ...
    listing = bob_client.get(f"{bob_client.ws}/projects/{project_id}/files")
    ...
    delete = bob_client.delete(f"{bob_client.ws}/projects/{project_id}/files/secret.txt")

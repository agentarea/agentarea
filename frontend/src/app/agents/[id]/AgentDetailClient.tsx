...
export default function AgentDetailClient({ agent }: Props) {
  ...
  return (
    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full h-full overflow-hidden flex flex-col">
      ...
      <TabsContent value="create" className="h-full overflow-hidden">
        <AgentChat
          agent={agent}

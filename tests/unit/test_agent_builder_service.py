...
class TestAgentBuilderService:
    ...
    @pytest.fixture
    def agent_builder_service(self, mock_repository, mock_event_broker, mock_llm_service, mock_mcp_service):
    ...
    async def test_build_agent_config_success(self, agent_builder_service, mock_repository, mock_llm_service, sample_agent, sample_llm_instance):
    ...
    async def test_build_agent_config_model_not_found(self, agent_builder_service, mock_repository, mock_llm_service, sample_agent):
    ...
    async def test_validate_agent_config_success(self, agent_builder_service, mock_repository, mock_llm_service, sample_agent, sample_llm_instance):
    ...
    async def test_validate_agent_config_missing_fields(self, agent_builder_service, mock_repository, sample_agent):
    ...
    async def test_get_agent_capabilities_planning_enabled(self, agent_builder_service, mock_repository, mock_llm_service, sample_agent, sample_llm_instance):
    ...
    async def test_get_agent_capabilities_no_planning(self, agent_builder_service, mock_repository, mock_llm_service, sample_agent, sample_llm_instance):
    ...
    async def test_get_agent_capabilities_agent_not_found(self, agent_builder_service, mock_repository):

"""Message models for agent execution workflows.
...
# ReActMessage and StatusMessage removed - these don't belong in conversation history
# ReAct reasoning should be part of regular AssistantMessage content
# Status updates should be handled via event sourcing, not conversation history
...
# ReActMessage removed - ReAct reasoning is just regular AssistantMessage content
        else:
            # Handle BaseMessage, UserMessage, SystemMessage, StatusMessage
            return cls(
                role=base_msg.role,
                content=base_msg.content,
                timestamp=base_msg.timestamp,
...
# Factory functions for ReActMessage and StatusMessage removed
# ReAct reasoning should use create_assistant_message()
# Status updates should use event sourcing, not conversation messages
